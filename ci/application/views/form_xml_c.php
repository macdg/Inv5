...
$datos_concepto['cantidad']=$cantidad;
$datos_concepto['descrip']=$descrip;
$datos_concepto['val_unit']=$val_unit;
$datos_concepto['unidad']=$unidad;
...
<div> 
    ...
    echo br(1). heading('XML 2', 2); ?>
        ...
        <table border=1 width="900">
            <tr>
                <?php for ($i=0; $i<$cont; $i++): echo form_open('index.php/up_xml_c/borrar');  ?>
...
<div>
    <?php   if(isset($mcantidad)): echo form_open('index.php/up_xml_c/solicitar2'). br(1);?> <hr> <?php echo heading('Ingresar Productos', 2);  
